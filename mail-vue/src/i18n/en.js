const en = {
    ...
    oidcEnabled: 'OIDC Login',
    oidcProvider: 'OIDC Provider',
    oidcClientId: 'Client ID',
    oidcClientSecret: 'Client Secret',
    oidcDiscoveryUrl: 'Discovery URL',
    oidcScopes: 'Scopes',
    oidcDesc: 'Configure OIDC provider to enable OIDC login',
    oidcCallbackUrl: 'OIDC Callback URL',
    oauthConfig: 'OAuth Authorization Login',
    oauthEnabled: 'OAuth Login',
    oauthProvider: 'OAuth Provider',
    oauthClientId: 'App ID',
    oauthClientSecret: 'App Secret',
    oauthAuthUrl: 'Authorization URL',
    oauthTokenUrl: 'Token URL',
    oauthUserInfoUrl: 'User Info URL',
    oauthScopes: 'Scopes',
    oauthDesc: 'Configure OAuth provider to enable third-party login',
    oauthCallbackUrl: 'OAuth Callback URL',
    selectProvider: 'Select Provider',
    customProvider: 'Custom',
    customProviderName: 'Custom Provider Name',
    customProviderNamePlaceholder: 'e.g., Linux DO, Enterprise SSO, etc',
    oauthTenantId: 'Azure AD Tenant ID',
    oauthTenantIdPlaceholder: 'Leave empty for common (multi-tenant), or enter tenant ID',
    github: 'GitHub',
    google: 'Google',
    microsoft: 'Microsoft',
    ...
    unbindOauth: 'Unbind',
    oauthBindingDesc: 'After binding an OAuth account, you can use OAuth to login',
    oauthBindingSuccess: 'OAuth account bound successfully',
    oauthUnbindSuccess: 'OAuth account unbound successfully',
    oauthBindingFailed: 'Failed to bind OAuth account',
    oauthUnbindFailed: 'Failed to unbind OAuth account',
    confirmUnbindOauth: 'Are you sure you want to unbind this OAuth account?',
    bound: 'Bound',
