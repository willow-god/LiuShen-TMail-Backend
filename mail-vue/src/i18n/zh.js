const zh = {
    ...
    oidcConfig: 'OIDC 配置',
    oidcEnabled: 'OIDC 登录',
    oidcProvider: 'OIDC 提供商',
    oidcClientId: '客户端 ID',
    oidcClientSecret: '客户端密钥',
    oidcDiscoveryUrl: '发现 URL',
    oidcScopes: '权限范围',
    oidcDesc: '配置 OIDC 提供商以启用 OIDC 登录',
    oidcCallbackUrl: 'OIDC 回调地址',
    oauthConfig: 'OAuth 授权登录',
    oauthEnabled: 'OAuth 登录',
    oauthProvider: 'OAuth 提供商',
    oauthClientId: '应用 ID',
    oauthClientSecret: '应用密钥',
    oauthAuthUrl: '授权 URL',
    oauthTokenUrl: 'Token URL',
    oauthUserInfoUrl: '用户信息 URL',
    oauthScopes: '权限范围',
    oauthDesc: '配置 OAuth 提供商以启用第三方登录',
    oauthCallbackUrl: 'OAuth 回调地址',
    selectProvider: '选择提供商',
    customProvider: '自定义',
    customProviderName: '自定义提供商名称',
    customProviderNamePlaceholder: '例如：Linux DO、企业内部SSO等',
    oauthTenantId: 'Azure AD 租户ID',
    oauthTenantIdPlaceholder: '留空使用 common（多租户），或输入租户ID',
    github: 'GitHub',
    google: 'Google',
    microsoft: 'Microsoft',
    ...
    unbindOauth: '解绑',
    oauthBindingDesc: '绑定 OAuth 账号后，可以使用 OAuth 账号登录',
    oauthBindingSuccess: 'OAuth 账号绑定成功',
    oauthUnbindSuccess: 'OAuth 账号解绑成功',
    oauthBindingFailed: 'OAuth 账号绑定失败',
    oauthUnbindFailed: 'OAuth 账号解绑失败',
    confirmUnbindOauth: '确定要解绑此 OAuth 账号吗？',
    bound: '已绑定',
    configSaved: '配置已保存',
    configFailed: '配置保存失败'
}
