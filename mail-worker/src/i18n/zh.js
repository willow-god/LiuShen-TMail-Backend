const zh = {
	...
	oauthUserNotFound: '未找到绑定的用户，请先在个人设置中绑定您的 OAuth 账号后再使用 OAuth 登录',
	oauthAlreadyBound: '您已绑定该 OAuth 提供商',
	oauthIdAlreadyUsed: '该 OAuth 账号已被其他用户绑定',
	oauthNotEnabled: 'OAuth 功能未启用',
	oauthNotConfigured: 'OAuth 未配置',
	oauthNotBound: '未找到 OAuth 绑定',
	oauthNoRefreshToken: '没有可用的刷新令牌',
