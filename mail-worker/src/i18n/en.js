const en = {
	...
	oauthUserNotFound: 'No bound user found. Please bind your OAuth account in settings before using OAuth login',
	oauthAlreadyBound: 'You have already bound this OAuth provider',
	oauthIdAlreadyUsed: 'This OAuth account is already bound to another user',
	oauthNotEnabled: 'OAuth is not enabled',
	oauthNotConfigured: 'OAuth is not configured',
	oauthNotBound: 'OAuth binding not found',
	oauthNoRefreshToken: 'No refresh token available',
